        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorites_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WatchedMatches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WatchedMatches_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WatchedMatches_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WatchlistItems_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WatchedMatches_MatchId",
                table: "WatchedMatches",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_WatchedMatches_UserId",
                table: "WatchedMatches",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WatchlistItems_MatchId",
                table: "WatchlistItems",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_WatchlistItems_UserId_MatchId",
                table: "WatchlistItems",
